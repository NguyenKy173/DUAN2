...
const ProductDetail = () => {
    return (
            ...
            <div className="grid grid-cols-2 gap-8">
                <div className="grid grid-cols-6 gap-8">
                    ...
                    <div className="col-span-5">
                        <img src="./cuoi1.jpg" alt="" />
                    </div>
                </div>
                {/* <!-- END  --> */}
                <div>
                    <p className="font-semibold text-xl">Asgaard sofa</p>
                    ...
                    <div>
                        ...
                        <div className="flex gap-4">
                            <div className="flex items-center justify-center text-white rounded bg-yellow-600 w-[30px] h-[30px]">L</div>
                            <div className="flex items-center justify-center text-white rounded bg-neutral-400 w-[30px] h-[30px]">XL</div>
                            <div className="flex items-center justify-center text-white rounded bg-neutral-400 w-[30px] h-[30px]">XS</div>
                        </div>
                    </div>
        ...
        <section className="my-16">
            <div className=" mb-4">
                <h2 className="font-semibold text-[40px] text-center">New product</h2>
            </div>
