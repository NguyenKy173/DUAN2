    ...
    return (
        <>
           <section className="container max-w-screen-xl m-auto mt-16">
            ...
            <div className="grid  gap-8">
                <Carousel
                    responsive={responsive} containerClass="relative" itemClass="p-2" arrows={true} customLeftArrow={<CustomLeftArrow />} customRightArrow={<CustomRightArrow />}
                    >
                    {products?.map((item) => (
                        ...
                        <div className="bg-[#F5F5F5] p-4">
                            ...
                            <Link to="/cart">
                            <button className="border border-yellow-700 text-yellow-700 w-full font-semibold text-base py-2 hover:bg-yellow-700 hover:text-white transition">
                                Add to Cart
                            </button>
                            </Link>
                        </div>
        ...
        <section className="container max-w-screen-xl m-auto mt-16">
            <div className="flex justify-between items-center mb-4">
                ...
                <Link to="/shop" className="border border-solid border-yellow-500 px-4 py-2 font-semibold text-base text-yellow-500">View all </Link>
            </div>
            <div className="grid  gap-2 pb-2 border-solid">
            {categories && categories.length > 0 ? (
                <Carousel  responsive={responsive} containerClass="relative" itemClass="p-2" arrows={true} customLeftArrow={<CustomLeftArrow />} customRightArrow={<CustomRightArrow />}>
