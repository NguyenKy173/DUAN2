        ...
        <section className="bg-[#FFF7ED] py-16 mt-16">
            <div className="container max-w-screen-xl m-auto grid grid-cols-4">
                <div className="flex gap-5 items-center">
                    <Link to =""><img src="assets/image/quantity-1.png" alt=""/></Link>
                    <div>
                ...
                <div className="flex gap-5 items-center">
                <Link to =""><img src="assets/image/quantity-2.png" alt=""/></Link>
                    <div>
                ...
                <div className="flex gap-5 items-center">
                <Link to =""><img src="assets/image/quantity-3.png" alt=""/></Link>
                    <div>
                ...
                <div className="flex gap-5 items-center">
                <Link to =""><img src="assets/image/quantity-4.png" alt=""/></Link>
                    <div>
